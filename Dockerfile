...
RUN \
    ...
    apt-get install gcc-multilib wget unzip
...
RUN \
    mkdir /data;\
    wget http://ponder2.net/downloads/Ponder2Tutorial.zip -O /data/tutorial.zip;\
    unzip /data/tutorial.zip -d /data;


ENTRYPOINT cd /data/Ponder2Tutorial/ && ./ant
EXPOSE 13570